async def greeting_text(user_full_name: str) -> str:
    return (
        ...
        f'/this_mount_is даёт ответ на вопрос: какие дни в текущим месяце БУД рабочие, какие ВЫХ выходные? \n'
        f'/this_year_is даёт информацию на выбор 12 месяцев текущего года \n'
    )
